    ...
    with(options) {
        ...
        if (get) {
            ...
            if (type === 'Media' && property === 'Album')
                userInfo = 'albumName';
            aggrandizements.push(Object.assign({ PropertyName: property }, (userInfo && { PropertyUserInfo: userInfo }), { Type: 'WFPropertyVariableAggrandizement' }));
        }
        if (dateFormat) {
            aggrandizements.push(Object.assign({ WFDateFormatStyle: dateFormat === 'How Long Ago/Until' ? 'Relative' : dateFormat }, (dateFormat !== 'Custom' &&
                dateFormat !== 'RFC 2822' &&
                dateFormat !== 'ISO 8601' &&
